...
a class = "nav-link"
href = "share-receipt-form" > Share recipe < /a{">"} <
a class = "nav-link"
href = "#" > Logout < /a> <
a class = "nav-link"
href = "defaultRegisterFormUsername" > Login < /a> <
a class = "nav-link"
href = "#" > Register < /a> < /
nav > <
    /div> < /
...
div >
    ...
    div class = "team-front" >
    <
    img src = "https://image.shutterstock.com/image-photo/assorted-dairy-products-milk-yogurt-260nw-530162824.jpg" / >
    <
    h3 > Meal Name < /h3> <
...
div >
    ...
    div class = "team-front" >
    <
    img src = "https://t3.ftcdn.net/jpg/01/18/84/52/240_F_118845283_n9uWnb81tg8cG7Rf9y3McWT1DT1ZKTDx.jpg" / >
    <
    h3 > Meal Name < /h3> <
...
<
form class = "text-center p-5 form-layout"
action = "#"
method = "POST"
...
select >
    ...
    <
    button class = "btn btn-danger w-25 m-auto my-4 btn-block"
type = "submit" > Share it < /button> < /
form >
...
placeholder = "Repeat Password" >
    <
    button class = "btn btn-danger my-4 btn-block w-25 m-auto"
