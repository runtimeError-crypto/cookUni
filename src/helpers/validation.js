...
const msgs = null;
exportlet
const signupValidation = ({ firstname, lastname, username, password, password2 }) => {
...
const msgCounter = null;
export const createValidation = ({ meal, ingredients, prepMethod, description, foodImageURL, category }) => {
    console.log('[Validation] Perform New/Edit Recipe Validation') let msgCounter = 0; //reset counter
